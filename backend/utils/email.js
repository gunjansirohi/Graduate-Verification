...
exports.sendPasswordResetEmail = async (email, code) => {
  const appName = process.env.APP_NAME || "GLA University GCVS";
  ...
  try {
    const mailOptions = {
      from: `"${appName} Support" <${
        process.env.EMAIL_USER || "madishamadiso00@gmail.com"
      }>`,
      to: email,
        ...
        <body>
          ...
          <div class="instructions">
            ...
            <ol>
              ...
              ${
                resetLink
                  ? `<li>Or <a href="${resetLink}" class="button">Click here to reset password</a></li>`
                  : ""
              }
